...
plt.savefig("../../reports/figures/LOF_Plot_Gyroscope_Day2")
plt.show()
...
plt.legend()
plt.savefig("../../reports/figures/DBSCAN_Plot_Gyroscope")
plt.show()
...
df["RotationVector_xSinThetaOver2_MEAN"] = df_T["RotationVector_xSinThetaOver2_MEAN"]
df["RotationVector_zSinThetaOver2_MEAN"] = df_T ["RotationVector_zSinThetaOver2_MEAN"]
...
snsplot.savefig(OUTPUT_FIG+"factorplot")
'''