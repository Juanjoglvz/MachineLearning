...
# By looking at the dendogram, we can see that columns 3, 4 and 5 have very similar values
# This means we can remove two of the covariance columns, since their information is very similar.
